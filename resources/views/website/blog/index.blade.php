                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <article class="main-post-box">
                                <div class="featured-post">
                                    <div class="entry-image">
                                        <img src="{{ asset('/') }}website/assets/images/image-box/articel-post-1.jpg" alt="images">
                                    </div>
                                </div>
                            ...
                            <article class="main-post-box">
                                <div class="featured-post">
                                    <div class="entry-image">
                                        <img src="{{ asset('/') }}website/assets/images/image-box/articel-post-2.jpg" alt="images">
                                    </div>
                                </div>
                                <div class="post-content">
                                    <ul class="post-meta">
                            ...
                            <article class="main-post-box">
                                <div class="featured-post">
                                    <div class="entry-image">
                                        <img src="{{ asset('/') }}website/assets/images/image-box/articel-post-3.jpg" alt="images">
                                    </div>
                                </div>
                                <div class="post-content">
                                    <ul class="post-meta">
                            ...
                            <article class="main-post-box">
                                <div class="featured-post">
                                    <div class="entry-image">
                                        <img src="{{ asset('/') }}website/assets/images/image-box/articel-post-4.jpg" alt="images">
                                    </div>
                                </div>
                                <div class="post-content">
                                    <ul class="post-meta">
                                        ...
                                        <ul class="widget-post-item margin-bottom-5">
                                            <li>
                                                <div class="thumb-image border-radius-4 margin-bottom-17">
                                                    <img src="{{ asset('/') }}website/assets/images/image-box/thumb-post-1.jpg" alt="images">
                                                </div>
                                            ...
                                            <li>
                                                <div class="thumb-image border-radius-4 margin-bottom-17">
                                                    <img src="{{ asset('/') }}website/assets/images/image-box/thumb-post-2.jpg" alt="images">
                                                </div>
                                                <div class="thumb-content">
                                                    <a href="blog-single.html"
                                            ...
                                            <li>
                                                <div class="thumb-image border-radius-4 margin-bottom-17">
                                                    <img src="{{ asset('/') }}website/assets/images/image-box/thumb-post-3.jpg" alt="images">
                                                </div>
                                                <div class="thumb-content">
                                                    <a href="blog-single.html"
                                            ...
                                            <li>
                                                <div class="thumb-image border-radius-4 margin-bottom-17">
                                                    <img src="{{ asset('/') }}website/assets/images/image-box/thumb-post-4.jpg" alt="images">
                                                </div>
                                                <div class="thumb-content">
                                                    <a href="blog-single.html"
                                        ...
                                        <ul class="widget-gallery-item">
                                            <li>
                                                <div class="thumb-instagram">
                                                    <img src="{{ asset('/') }}website/assets/images/image-box/instag-post-1.jpg" alt="images">
                                            ...
                                            <li>
                                                <div class="thumb-instagram">
                                                    <img src="{{ asset('/') }}website/assets/images/image-box/instag-post-2.jpg" alt="images">
                                                    <div class="thumb-overlay-effect">
                                                        <a href="#" class="instagram-icon-thumb"></a>
                                                    </div>
                                                </div>
                                            ...
                                            <li>
                                                <div class="thumb-instagram">
                                                    <img src="{{ asset('/') }}website/assets/images/image-box/instag-post-3.jpg" alt="images">
                                                    <div class="thumb-overlay-effect">
                                                        <a href="#" class="instagram-icon-thumb"></a>
                                                    </div>
                                                </div>
                                            ...
                                            <li>
                                                <div class="thumb-instagram">
                                                    <img src="{{ asset('/') }}website/assets/images/image-box/instag-post-4.jpg" alt="images">
                                                    <div class="thumb-overlay-effect">
                                                        <a href="#" class="instagram-icon-thumb"></a>
                                                    </div>
                                                </div>
                                            ...
                                            <li>
                                                <div class="thumb-instagram">
                                                    <img src="{{ asset('/') }}website/assets/images/image-box/instag-post-5.jpg" alt="images">
                                                    <div class="thumb-overlay-effect">
                                                        <a href="#" class="instagram-icon-thumb"></a>
                                                    </div>
                                                </div>
                                            ...
                                            <li>
                                                <div class="thumb-instagram">
                                                    <img src="{{ asset('/') }}website/assets/images/image-box/instag-post-6.jpg" alt="images">
                                                    <div class="thumb-overlay-effect">
                                                        <a href="#" class="instagram-icon-thumb"></a>
                                                    </div>
                                                </div>
                                    ...
                                    <ul class="widget-recent-post-item">
                                        <li>
                                            <div class="thumb-image border-radius-4">
                                                <img src="{{ asset('/') }}website/assets/images/image-box/recent-post-1.jpg" alt="images">
                                            </div>
                                            <div class="thumb-content">
                                                <a href="blog-single.html"
                                        ...
                                        <li>
                                            <div class="thumb-image border-radius-4">
                                                <img src="{{ asset('/') }}website/assets/images/image-box/recent-post-2.jpg" alt="images">
                                            </div>
                                            <div class="thumb-content">
                                                <a href="blog-single.html"
                                        ...
                                        <li>
                                            <div class="thumb-image border-radius-4">
                                                <img src="{{ asset('/') }}website/assets/images/image-box/recent-post-3.jpg" alt="images">
                                            </div>
                                            <div class="thumb-content">
                                                <a href="blog-single.html"
