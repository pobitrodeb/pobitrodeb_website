...
<body class="header-fixed preloading">
    ...
    <div id="wrapper" class="animsition">
        <div id="page" class="clearfix">
                            ...
                            <nav id="main-nav" class="main-nav">
                                <ul id="menu-primary-menu" class="menu">
                                    ...
                                    <li class="menu-item menu-item-has-children current-menu-item">
                                        ...
                                        <ul class="sub-menu">
                                            <li class="menu-item current-item"><a href="services.html">Services</a></li>
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="breadcrumbs text-center link-style-5 text-white">
                            <h2 class="section-title-page">Our Services</h2>
                            <ul class="breadcrumbs-inner list-center display-flex">
                                <li><a class="section-16px-regular font-weight-500" href="index.html">Home</a></li>
                                <li>
                                    <h4 class="section-16px-regular font-weight-500">Our Services</h4>
                                </li>
                            </ul>
                        </div>
                    </div>
            ...
            <section class="flat-list-services">
                <div class="container">
                    <div class="row">
                        <div class="col-md-4">
                            <div class="list-services-box grow-up-hover wow fadeInUp" data-wow-delay="0ms"
                                ...
                                <div class="post-services">
                                    <img src="{{ asset('/') }}website/assets/images/image-box/services-post-1.jpg" class="grow-up-hover"
                                        alt="images">
                                ...
                                <div class="content-services">
                                    <div class="content-services-inner">
                                        <a href="service-single.html" class="section-20px-montserrat">UX/UI Design</a>
                                        <p class="section-17px-regular margin-top-10">Etiam efficitur, metus in cursus
                                            imperdiet, neque nisl porta erat, nec volutpat felis lacus a tellus.</p>
                                    </div>
                                    <div class="button-readmore">
                                        <a href="service-single.html" class="read-more">Service Details</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="list-services-box grow-up-hover wow fadeInUp" data-wow-delay="300ms"
                                data-wow-duration="1500ms">
                                <div class="post-services">
                                    <img src="{{ asset('/') }}website/assets/images/image-box/services-post-2.jpg" class="grow-up-hover"
                                        alt="images">
                                    <div class="icon-item-services">
                                        <span class="icon-services icon-web-design1 font-size-icon active"></span>
                                    </div>
                                </div>
                                <div class="content-services">
                                    <div class="content-services-inner">
                                        <a href="service-single.html" class="section-20px-montserrat">Web Design</a>
                                        <p class="section-17px-regular margin-top-10">Etiam efficitur, metus in cursus
                                            imperdiet, neque nisl porta erat, nec volutpat felis lacus a tellus.</p>
                                    </div>
                                    <div class="button-readmore">
                        ...
                        <div class="col-md-4">
                            <div class="list-services-box grow-up-hover wow fadeInUp" data-wow-delay="600ms"
                                data-wow-duration="1500ms">
                                <div class="post-services">
                                    <img src="{{ asset('/') }}website/assets/images/image-box/services-post-3.jpg" class="grow-up-hover"
                                        alt="images">
                                    <div class="icon-item-services">
                                ...
                                <div class="content-services">
                                    <div class="content-services-inner">
                                        <a href="service-single.html" class="section-20px-montserrat">Web
                                            Development</a>
                                        <p class="section-17px-regular margin-top-10">Etiam efficitur, metus in cursus
                                            imperdiet, neque nisl porta erat, nec volutpat felis lacus a tellus.</p>
                                    </div>
                        ...
                        <div class="col-md-4">
                            <div class="list-services-box grow-up-hover wow fadeInUp" data-wow-delay="0ms"
                                data-wow-duration="1500ms">
                                <div class="post-services">
                                    <img src="{{ asset('/') }}website/assets/images/image-box/services-post-4.jpg" class="grow-up-hover"
                                        alt="images">
                                    <div class="icon-item-services">
                                        <span class="icon-services icon-setting1 font-size-icon active"></span>
                                    </div>
                                </div>
                                <div class="content-services">
                                    <div class="content-services-inner">
                                        <a href="service-single.html" class="section-20px-montserrat">Software
                                            Development</a>
                                        <p class="section-17px-regular margin-top-10">Etiam efficitur, metus in cursus
                                            imperdiet, neque nisl porta erat, nec volutpat felis lacus a tellus.</p>
                                    </div>
                        ...
                        <div class="col-md-4">
                            <div class="list-services-box grow-up-hover wow fadeInUp" data-wow-delay="300ms"
                                data-wow-duration="1500ms">
                                <div class="post-services">
                                    <img src="{{ asset('/') }}website/assets/images/image-box/services-post-5.jpg" class="grow-up-hover"
                                        alt="images">
                                    <div class="icon-item-services">
                                ...
                                <div class="content-services">
                                    <div class="content-services-inner">
                                        <a href="service-single.html" class="section-20px-montserrat">Digital
                                            Marketing</a>
                                        <p class="section-17px-regular margin-top-10">Etiam efficitur, metus in cursus
                                            imperdiet, neque nisl porta erat, nec volutpat felis lacus a tellus.</p>
                                    </div>
                        ...
                        <div class="col-md-4">
                            <div class="list-services-box grow-up-hover wow fadeInUp" data-wow-delay="600ms"
                                data-wow-duration="1500ms">
                                <div class="post-services">
                                    <img src="{{ asset('/') }}website/assets/images/image-box/services-post-6.jpg" class="grow-up-hover"
                                        alt="images">
                                    <div class="icon-item-services">
                                        <span class="icon-services icon-cellphone1 font-size-icon active"></span>
                                    </div>
                                </div>
                                <div class="content-services">
                                    <div class="content-services-inner">
                                        <a href="service-single.html" class="section-20px-montserrat">Apps
                                            Development</a>
                                        <p class="section-17px-regular margin-top-10">Etiam efficitur, metus in cursus
                                            imperdiet, neque nisl porta erat, nec volutpat felis lacus a tellus.</p>
                                    </div>
            ...
            <section class="flat-about-work">
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-md-5">
                            <div class="about-work-post wow fadeInLeft">
                                <img src="{{ asset('/') }}website/assets/images/image-box/about-work-post.jpg" alt="images">
                            </div>
                        </div>
                        <div class="col-md-7">
                            <div class="about-work-content wow fadeInUp">
                                <h4 class="section-subtitle">How i work</h4>
                                <h2 class="section-45px-montserrat margin-top-15 margin-bottom-12">How Do We Create
                                    Better Products</h2>
                                <p class="section-17px-regular margin-bottom-58">Etiam efficitur, metus in cursus
                                ...
                                <div class="button-readmore link-style-5 wow fadeInDown">
                                    <a href="portfolio-single.html" class="read-more">See how we work</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-5">
                            <div class="contact-me-post wow fadeInRight">
                                <img src="{{ asset('/') }}website/assets/images/image-box/hire-me-post.png" alt="">
                            </div>
                        </div>
                    </div>
                </div>
