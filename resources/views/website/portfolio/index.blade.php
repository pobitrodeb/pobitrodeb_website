                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="portfolio-box wow fadeInUp" data-wow-delay="0.2s">
                                <div class="portfolio-post">
                                    <img src="{{ asset('/') }}website/assets/images/image-box/portfolio-post-2.jpg" alt="images">
                                </div>
                            ...
                            <div class="portfolio-box wow fadeInUp" data-wow-delay="0.4s">
                                <div class="portfolio-post">
                                    <img src="{{ asset('/') }}website/assets/images/image-box/portfolio-post-3.jpg" alt="images">
                                </div>
                                <div class="portfolio-content">
                                    <a href="portfolio-single.html" class="mark-item"></a>
                                    <div class="title-item link-style-5">
                        ...
                        <div class="col-md-8">
                            <div class="portfolio-box active">
                                <div class="portfolio-post">
                                    <img src="{{ asset('/') }}website/assets/images/image-box/portfolio-post-1.jpg" alt="images">
                                </div>
                                <div class="portfolio-content">
                                    <a href="portfolio-single.html" class="mark-item"></a>
                                    <div class="title-item link-style-5">
                        ...
                        <div class="col-md-8">
                            <div class="portfolio-box">
                                <div class="portfolio-post">
                                    <img src="{{ asset('/') }}website/assets/images/image-box/portfolio-post-4.jpg" alt="images">
                                </div>
                                <div class="portfolio-content">
                                    <a href="portfolio-single.html" class="mark-item"></a>
                                    <div class="title-item link-style-5">
                        ...
                        <div class="col-md-4">
                            <div class="portfolio-box wow fadeInUp" data-wow-delay="0.2s">
                                <div class="portfolio-post">
                                    <img src="{{ asset('/') }}website/assets/images/image-box/portfolio-post-5.jpg" alt="images">
                                </div>
                                <div class="portfolio-content">
                                    <a href="portfolio-single.html" class="mark-item"></a>
                                    <div class="title-item link-style-5">
